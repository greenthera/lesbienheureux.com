...
const i18n = {
  en: {
    ...
    values_title: 'Founded on Ethics, Aesthetics and Excellence',
    val1_title: 'Blind Tasting',
    val1_desc: 'Every product is finalized only when it wins in blind tastings against its best competitors using black glasses — no compromise.',
    val2_title: 'Innovation',
    val2_desc: "We invest 10% of turnover in R&D, constantly pushing boundaries to create the category leaders of tomorrow.",
    val3_title: 'Ethical Values',
    val3_desc: 'All staff on open-ended contracts with a net minimum wage of €2,000/month. Suppliers treated as customers.',
    val4_title: 'French Roots',
    val4_desc: 'Fiscally based in France, receiving no subsidies, with our own brewery and distillery in Cognac-Bercloux.',
    val5_title: 'Award-Winning',
    val5_desc: 'The most gold medals in our sector. BELLEVOYE leads French whiskies, EL PASADOR DE ORO leads premium rum.',
    val6_title: 'Sustainability',
    val6_desc: "Production facilities in France and Costa Rica built around respect for people, the environment and local communities.",
  ...
  fr: {
    ...
    values_title: 'Fondée sur l\'éthique, l\'esthétique et l\'excellence',
    val1_title: 'Dégustation à l\'aveugle',
    val1_desc: 'Chaque produit n\'est finalisé que lorsqu\'il gagne lors des dégustations à l\'aveugle face à ses meilleurs concurrents, en utilisant des verres noirs — sans compromis.',
    val2_title: 'Innovation',
    val2_desc: 'Nous investissons 10% du chiffre d\'affaires en R&D, repoussant constamment les limites pour créer les leaders de catégorie de demain.',
    val3_title: 'Valeurs éthiques',
    val3_desc: 'Tous les salariés en CDI avec un salaire minimum net de 2 000 €/mois. Les fournisseurs traités comme des clients.',
    val4_title: 'Racines françaises',
    val4_desc: 'Domiciliée fiscalement en France, sans subventions, avec notre propre brasserie et distillerie à Cognac-Bercloux.',
    val5_title: 'Primée',
    val5_desc: 'Le plus grand nombre de médailles d\'or de notre secteur. BELLEVOYE mène les whiskies français, EL PASADOR DE ORO mène le rhum premium.',
    val6_title: 'Développement durable',
    val6_desc: 'Installations de production en France et au Costa Rica construites dans le respect des personnes, de l\'environnement et des communautés locales.',
  ...
  es: {
    ...
    values_title: 'Fundada en ética, estética y excelencia',
    val1_title: 'Cata ciega',
    val1_desc: 'Cada producto se finaliza solo cuando gana en catas ciegas frente a sus mejores competidores usando vasos negros — sin compromiso.',
    val2_title: 'Innovación',
    val2_desc: 'Invertimos el 10% de la facturación en I+D, empujando constantemente los límites para crear los líderes de categoría del mañana.',
    val3_title: 'Valores éticos',
    val3_desc: 'Todo el personal con contratos indefinidos y un salario mínimo neto de 2.000 €/mes. Los proveedores tratados como clientes.',
    val4_title: 'Raíces francesas',
    val4_desc: 'Con sede fiscal en Francia, sin subvenciones, con su propia cervecería y destilería en Cognac-Bercloux.',
    val5_title: 'Galardonada',
    val5_desc: 'El mayor número de medallas de oro de nuestro sector. BELLEVOYE lidera los whiskies franceses, EL PASADOR DE ORO lidera el ron premium.',
    val6_title: 'Sostenibilidad',
    val6_desc: 'Instalaciones de producción en Francia y Costa Rica construidas en torno al respeto por las personas, el medio ambiente y las comunidades locales.',
